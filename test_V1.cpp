...
int main()
{
    ...
    if (!backgroundImage.loadFromFile("src/image/map.png"))
    {
    ...
    if (!overlayImage.loadFromFile("src/image/map.png"))
    {
    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
            {
                ...
                //_______________________________________________________Fenetre Vendee________________________________________________________________________
                if (event.mouseButton.x >= button1.getPosition().x && event.mouseButton.x <= button1.getPosition().x + button1.getSize().x && event.mouseButton.y >= button1.getPosition().y && event.mouseButton.y <= button1.getPosition().y + button1.getSize().y)
				{
		            sf::Vector2i mousePosition = sf::Mouse::getPosition(window);
		            sf::Vector2f mousePositionF(static_cast<float>(mousePosition.x), static_cast<float>(mousePosition.y));
		            ...
		            // Le bouton a été cliqué
		            std::cout << "Vendee" << std::endl;
		            	
		            // Créer une nouvelle fenêtre
		            sf::RenderWindow subWindow(sf::VideoMode(600, 600), "Vendee");
                ...
                //_______________________________________________________Fenetre Bretagne________________________________________________________________________
                if (event.mouseButton.x >= button2.getPosition().x && event.mouseButton.x <= button2.getPosition().x + button2.getSize().x && event.mouseButton.y >= button2.getPosition().y && event.mouseButton.y <= button2.getPosition().y + button2.getSize().y)
				{
		            sf::Vector2i mousePosition = sf::Mouse::getPosition(window);
		            sf::Vector2f mousePositionF(static_cast<float>(mousePosition.x), static_cast<float>(mousePosition.y));
		            ...
		            // Le bouton a été cliqué
		            std::cout << "Bretagne" << std::endl;
		            	
		            // Créer une nouvelle fenêtre
		            sf::RenderWindow subWindow(sf::VideoMode(600, 600), "Bretagne");
		            ...
		            while (subWindow.isOpen())
                    {
                        ...
                        // Effacer le contenu de la sous-fenêtre
		                subWindow.clear(sf::Color::Green);
                ...
                //_______________________________________________________Fenetre Normandie________________________________________________________________________
                if (event.mouseButton.x >= button3.getPosition().x && event.mouseButton.x <= button3.getPosition().x + button3.getSize().x && event.mouseButton.y >= button3.getPosition().y && event.mouseButton.y <= button3.getPosition().y + button3.getSize().y)
				{
		            sf::Vector2i mousePosition = sf::Mouse::getPosition(window);
		            sf::Vector2f mousePositionF(static_cast<float>(mousePosition.x), static_cast<float>(mousePosition.y));
		            ...
		            // Le bouton a été cliqué
		            std::cout << "Normandie" << std::endl;
		            	
		            // Créer une nouvelle fenêtre
		            sf::RenderWindow subWindow(sf::VideoMode(600, 600), "Normandie");
		            ...
		            while (subWindow.isOpen())
                    {
						...
						// Dessiner le texte
    					subWindow.draw(buttonText3);
    						
		                // Afficher le contenu de la sous-fenêtre
		                subWindow.display();
                    }
                }
                //_______________________________________________________Fenetre Grand Est________________________________________________________________________
                if (event.mouseButton.x >= button4.getPosition().x && event.mouseButton.x <= button4.getPosition().x + button4.getSize().x && event.mouseButton.y >= button4.getPosition().y && event.mouseButton.y <= button4.getPosition().y + button4.getSize().y)
				{
		            sf::Vector2i mousePosition = sf::Mouse::getPosition(window);
		            sf::Vector2f mousePositionF(static_cast<float>(mousePosition.x), static_cast<float>(mousePosition.y));
		            ...
		            // Le bouton a été cliqué
		            std::cout << "Grand Est" << std::endl;
		            	
		            // Créer une nouvelle fenêtre
		            sf::RenderWindow subWindow(sf::VideoMode(600, 600), "Grand Est");
		            ...
		            while (subWindow.isOpen())
                    {
                        ...
                        // Effacer le contenu de la sous-fenêtre
		                subWindow.clear(sf::Color::Yellow);
						
						// Dessiner le texte
    					subWindow.draw(buttonText4);
    						
		                // Afficher le contenu de la sous-fenêtre
		                subWindow.display();
                    }
                }
                //_______________________________________________________Fenetre Grand Nord________________________________________________________________________
                if (event.mouseButton.x >= button5.getPosition().x && event.mouseButton.x <= button5.getPosition().x + button5.getSize().x && event.mouseButton.y >= button5.getPosition().y && event.mouseButton.y <= button5.getPosition().y + button5.getSize().y)
				{
		            sf::Vector2i mousePosition = sf::Mouse::getPosition(window);
		            sf::Vector2f mousePositionF(static_cast<float>(mousePosition.x), static_cast<float>(mousePosition.y));
		            ...
		            // Le bouton a été cliqué
		            std::cout << "Grand Nord" << std::endl;
		            	
		            // Créer une nouvelle fenêtre
		            sf::RenderWindow subWindow(sf::VideoMode(600, 600), "Grand Nord");
